...
from travelapp.models import Customer, Booking
...
class BookingForm(UserCreationForm):
    ...
    dateofbirth = forms.IntegerField(label='Address',widget=forms.NumberInput(attrs={'class':'form-control'}))
    Age = forms.IntegerField(label='Age',widget=forms.NumberInput(attrs={'class':'form-control'}))
    Requirements = forms.CharField(label='Requirements',widget=forms.TextInput(attrs={'class':'form-control'}))


    class Meta:
        model=User
        fields=['username','email','Address','dateofbirth','Age','Requirements']
...
class BookingProfileForm(forms.ModelForm):
    class Meta:
        model = Booking
        fields = ['name','email', 'Address','dateofbirth','Requirements']
        widgets = {
                'name': forms.TextInput(attrs={'class': 'form-control'}),
                # 'mobile': forms.NumberInput(attrs={'class': 'form-control'}),
                'email': forms.EmailInput(attrs={'class': 'form-control'}),
                'Address': forms.TextInput(attrs={'class': 'form-control'}),
                'dateofbirth': forms.NumberInput(attrs={'class': 'form-control'}),
